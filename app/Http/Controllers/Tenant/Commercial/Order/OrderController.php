...
use App\Services\Tenant\Commercial\Order\OrderService;
...
class OrderController extends Controller
{
  ...
  public function store(OrderDto $dto): JsonResponse
  {
    return $this->responseSuccess(
  ...
  public function update(OrderDto $dto, int $id): JsonResponse
  {
    return $this->responseSuccess(
