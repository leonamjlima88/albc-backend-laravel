...
namespace App\Services\Tenant\Stock\Product;

use App\Http\DataTransferObjects\Tenant\Stock\Product\ProductDto;
use App\Repositories\Tenant\Stock\Product\ProductRepository;
...
class ProductService
{
  ...
  {
    return RoleService::permissionTemplateDefault('product', 'Produto / Serviço');
  }  
}