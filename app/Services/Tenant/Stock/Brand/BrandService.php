...
namespace App\Services\Tenant\Stock\Brand;

use App\Http\DataTransferObjects\Tenant\Stock\Brand\BrandDto;
use App\Repositories\Tenant\Stock\Brand\BrandRepository;
...
class BrandService
{
  ...
  {
    return RoleService::permissionTemplateDefault('brand', 'Marca');
  }
}
