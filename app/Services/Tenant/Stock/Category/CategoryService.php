...
namespace App\Services\Tenant\Stock\Category;

use App\Http\DataTransferObjects\Tenant\Stock\Category\CategoryDto;
use App\Repositories\Tenant\Stock\Category\CategoryRepository;
...
class CategoryService
{
  ...
  {
    return RoleService::permissionTemplateDefault('category', 'Categoria');
  }  
}
